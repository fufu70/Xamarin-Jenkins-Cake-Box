...
sudo java -jar jenkins-cli.jar -s http://localhost:8080/jenkins install-plugin envinject warnings analysis-core analysis-collector violations pmd dry --username "$J_USERNAME" --password "$J_PASSWORD"
